...
void    start_page_one(t_game *game, t_pages *pages)
{
    ...
    pages->page[0] = mlx_xpm_file_to_image(game->mlxs[0], "assets/pages/intro.xpm", &(pages->width[0]), &(pages->height[0]));
    pages->buttons[0] = mlx_xpm_file_to_image(game->mlxs[0], "assets/buttons/button_start.xpm", &(pages->w_button[0]), &(pages->h_button[0]));
    ...
    mlx_put_image_to_window(game->mlxs[0], game->wins[0], pages->buttons[0], x_pos, y_pos);
}
